...
class SecTemplateFileSecurityItem(SecTemplateItem):
    def __init__(self, node: ET.Element):
        ...
        self.m_sFileSpec = parts[0].strip().strip('"') if len(parts) > 0 else ""
    ...
    def SortKey(self) -> str:
        return (self.__class__.__name__ + "!" + self.m_sFileSpec).lower()

    def Evaluate(self, sources: EffectiveStateSources, x_output_doc: ET.Element):
        # Real file ACL checking is extremely complex; for CLI we mark as "found" and "passed"
